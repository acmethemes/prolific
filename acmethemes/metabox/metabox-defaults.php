                ...
                <td>
                    ...
                    foreach ($prolific_sidebar_layout_options as $field) {
                        ...
                        <div class="hide-radio radio-image-wrapper" style="float:left; margin-right:30px;">
                            <input id="<?php echo esc_attr( $field['value'] ); ?>" type="radio" name="prolific_sidebar_layout" value="<?php echo esc_attr( $field['value'] ); ?>" <?php checked( $field['value'], $prolific_sidebar_layout ); ?>/>
