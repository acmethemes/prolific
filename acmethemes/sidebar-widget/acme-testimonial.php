    ...
    class Prolific_testimonial extends WP_Widget {
        ...
        public function form($instance) {
            ...
            <p>
                ...
                ?>
                <span class="img-preview-wrap" <?php echo esc_attr( $prolific_display_none ); ?>>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e('Select Page For Testimonial', 'prolific'); ?>:</label>
                <br/>
