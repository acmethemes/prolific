...
if ( ! class_exists( 'Prolific_service' ) ) {
    ...
    class Prolific_service extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Page For Service', 'prolific' ); ?>:</label>
                <br />
                                ...
                                while( $service_query->have_posts() ):$service_query->the_post();
                                    ...
                                    <div class="<?php echo esc_attr( $b_col ); ?>">
                                        <div class="service_item <?php echo esc_attr( $animation1 );?>">
                                            ...
                                            ?>
                                            <div class="service_info <?php echo esc_attr( $block_class ); ?>">
                                                <h3><?php the_title(); ?></h3>
